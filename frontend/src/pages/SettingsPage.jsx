...
const PREVIEW_MESSAGES = [
  { id: 1, content: "Hey! How's it going?", isSilent: false },
  { id: 2, content: "I'm doing great! Just working on some new features.", isSilent: true },
]
                    ...
                    PREVIEW_MESSAGES?.map((message) => (
                      <div key={message.id} className={`flex ${message.isSilent ? "justify-end" : "justify-start"}`}>
                        <div className={`max-w-[80%] rounded-xl p-3 shadow-sm ${message.isSilent ? "bg-primary text-primary-content" : "bg-base-200"}`}>
                          ...
                          <p className={`text-[10px] mt-1.5  ${message.isSilent ? "text-primary-content/70" : "text-base-content/70"}`}>
                            12.00 PM
                          </p>
                        </div>
                      </div>
